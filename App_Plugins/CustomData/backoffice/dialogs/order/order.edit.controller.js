 ...
 */
function OrderEditDialogController($scope, $routeParams, $q, $timeout, $window, appState, customDataResource, entityResource, navigationService, notificationsService, angularHelper, serverValidationManager, contentEditingHelper, fileManager, formHelper, umbRequestHelper, umbModelMapper, $http) {
    //setup scope vars
    $scope.model = {};
    ...
    function performGet() {
        ...
        if (angular.isObject(dialogOptions.entity)) {
            ...
            if (dialogOptions.create) {
                ...
                memberResource.getScaffold(dialogOptions.id, dialogOptions.contentType)
                    .then(function (data) {
                ...
                customDataResource.getById("Order", dialogOptions.id).then(function (data) {
                    $scope.loaded = true;
                    deferred.resolve(data);
                })
...
angular.module("umbraco").controller("MxOrders.Dialogs.Order.EditController", OrderEditDialogController);
